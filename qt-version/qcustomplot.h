...
class QCP_LIB_DECL QCPLayerable : public QObject {
    ...
    Q_PROPERTY(QCustomPlot
    *
    parentPlot READ
    parentPlot)
    Q_PROPERTY(QCPLayerable
    *
    parentLayerable READ
    parentLayerable)
    Q_PROPERTY(QCPLayer
    *
    layer READ
...
class QCP_LIB_DECL QCPLayoutGrid : public QCPLayout {
    ...
    Q_PROPERTY(QList<double>
    columnStretchFactors READ
    columnStretchFactors WRITE
    setColumnStretchFactors)
    Q_PROPERTY(QList<double>
    rowStretchFactors READ
    rowStretchFactors WRITE
...
class QCP_LIB_DECL QCPAxis : public QCPLayerable {
    ...
    *
    ...
    tickVector WRITE
    setTickVector)
    Q_PROPERTY(QVector<QString>
    tickVectorLabels READ
    tickVectorLabels WRITE
    setTickVectorLabels)
    ...
    selectedParts READ
    selectedParts WRITE
    setSelectedParts NOTIFY
    selectionChanged)
    Q_PROPERTY(SelectableParts
    selectableParts READ
    selectableParts WRITE
    setSelectableParts NOTIFY
    selectableChanged)
    Q_PROPERTY(QFont
    selectedTickLabelFont READ
    selectedTickLabelFont WRITE
    setSelectedTickLabelFont)
    Q_PROPERTY(QFont
    selectedLabelFont READ
    selectedLabelFont WRITE
    setSelectedLabelFont)
    Q_PROPERTY(QColor
    selectedTickLabelColor READ
    selectedTickLabelColor WRITE
    setSelectedTickLabelColor)
    Q_PROPERTY(QColor
    selectedLabelColor READ
    selectedLabelColor WRITE
    setSelectedLabelColor)
    Q_PROPERTY(QPen
    selectedBasePen READ
    selectedBasePen WRITE
    setSelectedBasePen)
    Q_PROPERTY(QPen
    selectedTickPen READ
    selectedTickPen WRITE
    setSelectedTickPen)
    Q_PROPERTY(QPen
    selectedSubTickPen READ
    selectedSubTickPen WRITE
    setSelectedSubTickPen)
    Q_PROPERTY(QCPLineEnding
    lowerEnding READ
    lowerEnding WRITE
    setLowerEnding)
    Q_PROPERTY(QCPLineEnding
...
class QCP_LIB_DECL QCustomPlot : public QWidget {
    ...
    Q_PROPERTY(Qt::AspectRatioMode
    backgroundScaledMode READ
    backgroundScaledMode WRITE
    setBackgroundScaledMode)
    Q_PROPERTY(QCPLayoutGrid
    *
    plotLayout READ
    plotLayout)
    ...
    Q_PROPERTY(Qt::KeyboardModifier
    multiSelectModifier READ
    multiSelectModifier WRITE
...
class QCP_LIB_DECL QCPAbstractLegendItem : public QCPLayoutElement {
    ...
    setSelectedFont)
    Q_PROPERTY(QColor
    selectedTextColor READ
    selectedTextColor WRITE
...
class QCP_LIB_DECL QCPLegend : public QCPLayoutGrid {
    ...
    selectableChanged)
    Q_PROPERTY(QPen
    selectedBorderPen READ
    selectedBorderPen WRITE
    setSelectedBorderPen)
    Q_PROPERTY(QPen
    selectedIconBorderPen READ
    selectedIconBorderPen WRITE
...
public:
  ...
  */
    ...
    signals:
            void
    selectionChanged(QCPLegend::SelectableParts
    parts);
...
class QCP_LIB_DECL QCPColorScale : public QCPLayoutElement {
    ...
    setDataRange NOTIFY
    dataRangeChanged)
    Q_PROPERTY(QCPAxis::ScaleType
    dataScaleType READ
    dataScaleType WRITE
    setDataScaleType NOTIFY
    dataScaleTypeChanged)
    Q_PROPERTY(QCPColorGradient
    gradient READ
    gradient WRITE
    setGradient NOTIFY
    gradientChanged)
...
class QCP_LIB_DECL QCPGraph : public QCPAbstractPlottable {
    ...
    Q_PROPERTY(QCPGraph
    *
    channelFillGraph READ
    channelFillGraph WRITE
    setChannelFillGraph)
...
class QCP_LIB_DECL QCPItemText : public QCPAbstractItem {
    ...
    positionAlignment READ
    positionAlignment WRITE
...
class QCP_LIB_DECL QCPItemPixmap : public QCPAbstractItem {
    ...
    Q_PROPERTY(Qt::AspectRatioMode
    aspectRatioMode READ
    aspectRatioMode)
    Q_PROPERTY(Qt::TransformationMode
    transformationMode READ
    transformationMode)
    Q_PROPERTY(QPen
    pen READ
    pen WRITE
